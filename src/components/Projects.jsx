...
const Projects = () => {
  ...
  return (
    <div name="work" id="work" className="w-full bg-[#10101a] py-32">
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center  h-full text-white">
        <div className="text-center">
          <h1 className="text-4xl font-bold inline border-b-4 border-gradient-custom">My Projects</h1>
          <p className="text-xl py-6 pb-12">During my learning as a developer, I have created many projects and shared them on LinkedIn and GitHub. I am always on the lookout for new and challenging projects to work on.</p>
        </div>
